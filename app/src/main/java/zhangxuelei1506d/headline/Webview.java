...
public class Webview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image_webview = (ImageView) findViewById(R.id.image_webview);
        ...
        image_webview.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void showShare() {
        ...
        oks.setImageUrl("http://p3.so.qhimgs1.com/t017bb2735ca8c279c3.jpg");
